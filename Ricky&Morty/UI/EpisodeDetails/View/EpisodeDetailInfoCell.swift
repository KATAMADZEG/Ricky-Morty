...
//  Ricky&Morty
//
//  Created by MacUser on 25.07.23.
//

import UIKit

final class EpisodeDetailInfoCell: UICollectionViewCell {
    static let cellIdentifier = "EpisodeDetailInfoCell"
    ...
    func configure(with model: FillEpisodeDetailModel) {
