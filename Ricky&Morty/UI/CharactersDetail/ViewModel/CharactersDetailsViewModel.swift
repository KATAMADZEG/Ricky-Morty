...
//                .init(type: .status , value: results.status.text),
//                .init(type: .gender , value: results.gender.rawValue),
//                .init(type: .type , value: results.type),
//                .init(type: .species , value: results.species),
//                .init(type: .origin , value: results.origin.name),
//                .init(type: .location , value: results.location.name),
//                .init(type: .created , value: results.created),
//                .init(type: .episodeCount , value: "\(results.episode.count)"),
//            ]),
